                    ...
                    <ul class="nav navbar-nav float-right">
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                <li class="dropdown-menu-header">
                                    <div class="dropdown-header m-0 p-2">
                                        <h3 class="white">{{$notif->count()}}</h3><span class="notification-title">App
                                            Notifications</span>
                                    </div>
                                </li>
                                    ...
                                    <a class="d-flex justify-content-between" id="notif" data-id="{{$item->id}}">
                                        <div class="media d-flex align-items-start">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small class="notification-text"> {{$item->customer}} | {{$item->kg}} kg
                                                    | {{Rupiah::getRupiah($item->harga_akhir)}}</small>
                                            </div>
                                            <small>
                                                <time
                                                    class="media-meta">{{Carbon\carbon::parse($item->updated_at)->diffForHumans()}}</time>
                                            </small>
                                        </div>
                                    </a>
                                    @endforeach
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                                ...
                                <div class="user-nav d-sm-flex d-none"><span
                                        ...
                                        class="user-status">{{auth::user()->auth}}</span></div><span><img class="round"
                                        src="{{asset('backend/images/portrait/small/haha.jpg')}}" alt="avatar"
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                @else
                                <a class="dropdown-item" href="{{url('profile-karyawan', auth::user()->id )}}"><i
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title"
                            data-i18n="User">Data Pengguna</span></a>
                    <ul class="menu-content">
                        <li><a href="{{url('adm')}}"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="List">Administrator</span></a>
                        </li>
                        <li><a href="{{url('kry')}}"><i class="feather icon-circle"></i><span class="menu-item"
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title"
                            data-i18n="User">Data Customer</span></a>
                    <ul class="menu-content">
                        <li><a href="{{url('customer')}}"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="List">Customer</span></a>
                        </li>
                    </ul>
                </li>

                <li class=" nav-item"><a href="#"><i class="feather icon-layers"></i><span class="menu-title"
                            data-i18n="User">Data Transaksi</span></a>
                    <ul class="menu-content">
                        <li><a href="{{url('data-transaksi')}}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="List">Transaksi</span></a>
                        </li>
                        <li><a href="{{url('data-harga')}}"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="List">Harga Laundry</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-credit-card"></i><span class="menu-title"
                            data-i18n="User">Data Finance</span></a>
                    <ul class="menu-content">
                        <li><a href="{{url('data-finance')}}"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="List">Finance</span></a>
                        </li>
                    </ul>
                </li>
                {{-- End Menu Admin --}}
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-layers"></i><span class="menu-title"
                            data-i18n="User">Data Transaksi</span></a>
                    <ul class="menu-content">
                        <li><a href="{{route('pelayanan.index')}}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="List">Order Masuk</span></a>
                        </li>
                        <li><a href="{{url('add-order')}}"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="List">Tambah Order</span></a>
                        </li>
                        <li><a href="{{url('list-customer')}}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="List">Data Customer</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item"><a href="{{url('/')}}" target="_blank"><i class="feather icon-square"></i><span
                            class="menu-title" data-i18n="Dashboard">Frontend</span></a>
                </li>
                @endif
                {{--End  --}}
            </ul>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span
                class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2020<a
                    class="text-bold-800 grey darken-2" href="https://www.instagram.com/nanang_stywn/"
                    target="_blank">Nanang Setyawan,</a>All rights Reserved</span><span
                class="float-md-right d-none d-md-block">Build With <i class="feather icon-heart pink"></i></span>
