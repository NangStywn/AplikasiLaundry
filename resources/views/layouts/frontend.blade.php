...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header-navbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                    <li><a style="background-color:#3bb39a" href="{{route('login')}}">Masuk</a>
                    </li>
                    @endauth
                </ul>
            </div>
    ...
    <div class="footer-copyright">
        <div class="container-fluid">
            &copy; 2020 Build With <i class="fa fa-heart" style="color:red"></i> - <a
                href="https://www.instagram.com/nanang_stywn/" target="_blank" style="text-decoration:none">Nanang
                Setyawan</a>
        </div>
    </div>
